...
# Form implementation generated from reading ui file 'ownertable.ui'
#
...
class Ui_LoginDialog(object):
    def setupUi(self, LoginDialog):
        ...
        self.addedit = QtWidgets.QLineEdit(LoginDialog)
        self.addedit.setObjectName("addedit")
        self.horizontalLayout.addWidget(self.addedit)
    ...
    def retranslateUi(self, LoginDialog):
        ...
        LoginDialog.setWindowTitle(_translate("LoginDialog", "持有者"))
        self.title.setText(_translate("LoginDialog", "持有者"))
